...
#
# client = mqtt.Client("R-1")
# client.connect(mqttBroker)
#
# client.loop_start()
#
# client.subscribe("TUBE")
...
def on_message_msgs(mosq, obj, msg):
    ...
    # $SYS/broker/messages/#
    print("MESSAGES: " + str(mosq) + ' - ' + msg.topic + " " + str(msg.qos) + " " + str(msg.payload.decode('UTF-8')))


# def on_message_bytes(mosq, obj, msg):
#     # This callback will only be called for messages with topics that match
#     # $SYS/broker/bytes/#
#     print("BYTES: " + msg.topic + " " + str(msg.qos) + " " + str(msg.payload.decode('UTF-8')))
