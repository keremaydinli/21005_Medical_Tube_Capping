...
#define HOMING_BUMP_MM      { 5, 3, 3 }       // (mm) Backoff from endstops after first bump
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 133*60, 133*60, 10*60, 60 }  // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_FEEDRATE 100      // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP 100 // (mm/s) Default feedrate for recovering from swap retraction
